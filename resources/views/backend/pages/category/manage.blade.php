          ...
          <div class="col-sm-12 col-xl-12">
			  ...
			  <thead>
			    <tr>
			      ...
			      <th scope="col">Primary / Sub Category</th>
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td>
			      	...
			      	<img src="{{asset('Backend/img/category')}}/{{ $cat->image}}" alt="" width="40">
			      ...
			      <td> 
			      	<div class="action-icons">
			      		<ul>
			      			...
			      			<li><a href=""  data-toggle="modal" data-target="#deleteCategory"><i class="fa fa-trash"></i></a></li>
			      		</ul>
			      		<!-- Delete Modal Start  -->
			    ...
			    <tr>
			      ...
			      <td>
			      	...
			      	<img src="{{asset('Backend/img/category')}}/{{ $subcat->image}}" alt="" width="40">
			     ...
			     <!--  <td>{{ $cat->slug}}</td>
			      ...
			      <td>
			      	...
			      	<span class="badge badge-warning">{{$subcat->name}}</span>
