            ...
            <div class="item" style="background-image: url({{asset('Backend/img/slider/'.$slider->image)}});">
               <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                     ...
                     <div class="button-holder fadeInDown-3"> <a href="{{$slider->buttion_url}}" class="btn-lg btn btn-uppercase btn-primary shop-now-button">{{$slider->buttion_text}}</a> </div>
                  </div>
                  <!-- /.caption --> 
               </div>
      ...
      <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
         <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
               <li class="active">
               <a data-transition-type="backSlide" href="#all" data-toggle="tab">All
               </a>
               </li>
             @foreach(App\Models\Backend\Category::orderBy('name','asc')->where('featured',1)->get() as $featured)
               <li>
                  <a data-transition-type="backSlide" href="#{{$featured->slug}}" data-toggle="tab">{{ $featured->name }}
                  </a>
               </li>
               ...
               <div class="products">
                  ...
                  <img  src="{{asset('Backend/img/product/'.$value->image)}}" alt="">
                     ...
                     <div class="product-info text-left">
                        <h3 class="name">
                           <a href="{{route('product.show',$value->slug)}}">{{$value->title}}
                           </a>
                        </h3>
                        ...
                        @if(!is_null($value->offer_price))
                           ...
                           <span class="price-before-discount">৳{{$value->reguler_price}}BDT</span>
               ...
               <div class="item">
                  <div class="blog-post">
                     <div class="blog-post-image">
                        <div class="image">
                         <a href="blog.html">
                           <img src="{{asset('Frontend/assets/images/blog-post/post1.jpg')}}" alt="">
                        </a> 
                     </div>
                     </div>
                     <!-- /.blog-post-image -->
                     <div class="blog-post-info text-left">
                        <h3 class="name">
                           <a href="#">Dolorem eum fugiat quo voluptas nulla pariatur
                           </a>
                        </h3>
                        <span class="info">By Saraha Smith &nbsp;|&nbsp; 21 March 2016 </span>
               ...
               <div class="item">
                  <div class="blog-post">
                     <div class="blog-post-image">
                        <div class="image"> 
                           <a href="blog.html">
                              <img src="{{asset('Frontend/assets/images/blog-post/post2.jpg')}}" alt=""></a> 
                           </div>
                     </div>
                     <!-- /.blog-post-image -->
                     <div class="blog-post-info text-left">
