			      ...
			      <td> 
			      	<div class="action-icons">
			      		<ul>
			      			...
			      			<li><a href=""  data-toggle="modal" data-target="#deleteDistrict"><i class="fa fa-trash"></i></a></li>
			      		</ul>
			      		<!-- Delete Modal Start  -->
			      		<div class="modal fade" id="deleteDistrict" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
